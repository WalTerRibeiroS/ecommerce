...
export const criarPedido = async (idUsuario, totalBruto, totalFrete, totalDescontado, total) => {
...
export const registrarItemsPedido = async (idPedido, idsBuscar, quantidades, precos, nomes) => {
